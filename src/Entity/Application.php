...
//        $this->aeAcCommissionsRebateRequest = $aeAcCommissionsRebateRequest;
        $this->aeAcCommissionsRebateRequest = strtoupper($aeAcCommissionsRebateRequest);
...
//        $this->aeAcInterestsContributionRequest = $aeAcInterestsContributionRequest;
        $this->aeAcInterestsContributionRequest = strtoupper($aeAcInterestsContributionRequest);
...
//        $this->aeAcLostFundContributionRequest = $aeAcLostFundContributionRequest;
        $this->aeAcLostFundContributionRequest = strtoupper($aeAcLostFundContributionRequest);
...
//        $this->fDfLoanProvidedAtImport = $fDfLoanProvidedAtImport;
        $this->fDfLoanProvidedAtImport = strtoupper($fDfLoanProvidedAtImport);
