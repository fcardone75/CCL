...
//        $this->dfLoanProvidedAtImport = $dfLoanProvidedAtImport;
        $this->dfLoanProvidedAtImport = strtoupper($dfLoanProvidedAtImport);
...
//        $this->dfContractSignatureDate = $dfContractSignatureDate;
        $this->dfContractSignatureDate = $this->getDfLoanProvidedAtImport() === 'S' ? $dfContractSignatureDate : '';
...
//        $this->dfIssueDate = $dfIssueDate;
        $this->dfIssueDate = $this->getDfLoanProvidedAtImport() === 'S' ? $dfIssueDate : '';
...
//        $this->dfPeriodicity = $dfPeriodicity;
        $this->dfPeriodicity = $this->getDfLoanProvidedAtImport() === 'S' ? $dfPeriodicity : '';
...
//        $this->dfFirstDepreciationDeadline = $dfFirstDepreciationDeadline;
        $this->dfFirstDepreciationDeadline = $this->getDfLoanProvidedAtImport() === 'S' ? $dfFirstDepreciationDeadline : '';
...
//        $this->dfPreDepreciationExists = strtoupper($dfPreDepreciationExists);
        $this->dfPreDepreciationExists = $this->getDfLoanProvidedAtImport() === 'S' ? strtoupper($dfPreDepreciationExists) : '';
...
//        $this->dfInstallmentAmount = $dfInstallmentAmount;
        $this->dfInstallmentAmount = $this->getDfLoanProvidedAtImport() === 'S' ? $dfInstallmentAmount : '';
...
//        $this->tRateType = $tRateType;
        $this->tRateType = $this->getDfLoanProvidedAtImport() === 'S' ? $tRateType : '';
    ...
    {
//        $this->tRate = $tRate;
        $this->tRate = $this->getDfLoanProvidedAtImport() === 'S' ? $tRate : '';
    ...
    {
//        $this->tTaeg = $tTaeg;
        $this->tTaeg = $this->getDfLoanProvidedAtImport() === 'S' ? $tTaeg : '';
