...
//    const PROD_PATH_PREFIX = 'LIGURIA/';
    const FTP_PATH_PREFIX = 'LIGURIA_COMMERCIO';
...
//die;
            ...
            $this->serverSFTP->closeConnection();
        } else {
...
// mantis 0009906: LIGUARIA GAL & CCL - Richiesta sviluppo componente conto capitale
                            if(!empty($additionalContributionCtrl->getId())) {
                                ...
                                $additionalContributionAdded[] = $additionalContributionCtrl;
                            }
// mantis 0009906: LIGUARIA GAL & CCL - Richiesta sviluppo componente conto capitale
...
//                                $applicationCtrl->getAeIbAIARegistrationDate($DataIscrizioneAIA);
                                $applicationCtrl->setAeIbAIARegistrationDate($DataIscrizioneAIA);
                            }
...
// mantis 0009906: LIGUARIA GAL & CCL - Richiesta sviluppo componente conto capitale
                if (!empty($additionalContributionAdded)) {
                    foreach ($additionalContributionAdded as $additionalContributionTmp) {
                        $additionalContributionTmp->setRegistryFileAudit($registryFileAudit);
                    }
                }
// mantis 0009906: LIGUARIA GAL & CCL - Richiesta sviluppo componente conto capitale
