...
ALTER TABLE public.additional_contribution OWNER TO ccl;
...
ALTER TABLE public.additional_contribution_id_seq OWNER TO ccl;
...
ALTER TABLE public.application OWNER TO ccl;
...
ALTER TABLE public.application_attachment OWNER TO ccl;
...
ALTER TABLE public.application_attachment_id_seq OWNER TO ccl;
...
ALTER TABLE public.application_group OWNER TO ccl;
...
ALTER TABLE public.application_group_id_seq OWNER TO ccl;
...
ALTER TABLE public.application_id_seq OWNER TO ccl;
...
ALTER TABLE public.application_import OWNER TO ccl;
...
ALTER TABLE public.application_import_id_seq OWNER TO ccl;
...
ALTER TABLE public.application_import_template OWNER TO ccl;
...
ALTER TABLE public.application_import_template_id_seq OWNER TO ccl;
...
ALTER TABLE public.application_message OWNER TO ccl;
...
ALTER TABLE public.application_message_attachment OWNER TO ccl;
...
ALTER TABLE public.application_message_attachment_id_seq OWNER TO ccl;
...
ALTER TABLE public.application_message_id_seq OWNER TO ccl;
...
ALTER TABLE public.application_status_log OWNER TO ccl;
...
ALTER TABLE public.application_status_log_id_seq OWNER TO ccl;
...
ALTER TABLE public.assurance_enterprise_import OWNER TO ccl;
...
ALTER TABLE public.assurance_enterprise_import_id_seq OWNER TO ccl;
...
ALTER TABLE public.ateco_code OWNER TO ccl;
...
ALTER TABLE public.ateco_code_id_seq OWNER TO ccl;
...
ALTER TABLE public.bank OWNER TO ccl;
...
ALTER TABLE public.bank_id_seq OWNER TO ccl;
...
ALTER TABLE public.bank_leasing OWNER TO ccl;
...
ALTER TABLE public.bank_leasing_id_seq OWNER TO ccl;
...
ALTER TABLE public.city OWNER TO ccl;
...
ALTER TABLE public.city_id_seq OWNER TO ccl;
...
ALTER TABLE public.company_size OWNER TO ccl;
...
ALTER TABLE public.company_size_id_seq OWNER TO ccl;
...
ALTER TABLE public.confidi OWNER TO ccl;
...
ALTER TABLE public.confidi_id_seq OWNER TO ccl;
...
ALTER TABLE public.country OWNER TO ccl;
...
ALTER TABLE public.country_id_seq OWNER TO ccl;
...
ALTER TABLE public.doctrine_migration_versions OWNER TO ccl;
...
ALTER TABLE public.ext_log_entries OWNER TO ccl;
...
ALTER TABLE public.ext_log_entries_id_seq OWNER TO ccl;
...
ALTER TABLE public.financial_destination OWNER TO ccl;
...
ALTER TABLE public.financial_destination_id_seq OWNER TO ccl;
...
ALTER TABLE public.financing_import OWNER TO ccl;
...
ALTER TABLE public.financing_import_id_seq OWNER TO ccl;
...
ALTER TABLE public.financing_provisioning_certification OWNER TO ccl;
...
ALTER TABLE public.financing_provisioning_certification_id_seq OWNER TO ccl;
...
ALTER TABLE public.leasing_destination OWNER TO ccl;
...
ALTER TABLE public.leasing_destination_id_seq OWNER TO ccl;
...
ALTER TABLE public.leasing_import OWNER TO ccl;
...
ALTER TABLE public.leasing_import_id_seq OWNER TO ccl;
...
ALTER TABLE public.legal_form OWNER TO ccl;
...
ALTER TABLE public.legal_form_id_seq OWNER TO ccl;
...
ALTER TABLE public.login_failure OWNER TO ccl;
...
ALTER TABLE public.login_failure_id_seq OWNER TO ccl;
...
ALTER TABLE public.periodicity OWNER TO ccl;
...
ALTER TABLE public.periodicity_id_seq OWNER TO ccl;
...
ALTER TABLE public.protocol_number OWNER TO ccl;
...
ALTER TABLE public.protocol_number_id_seq OWNER TO ccl;
...
ALTER TABLE public.registry_file_audit OWNER TO ccl;
...
ALTER TABLE public.registry_file_audit_id_seq OWNER TO ccl;
...
ALTER TABLE public.report_import OWNER TO ccl;
...
ALTER TABLE public.report_import_id_seq OWNER TO ccl;
...
ALTER TABLE public.sessions OWNER TO ccl;
...
ALTER TABLE public."user" OWNER TO ccl;
...
ALTER TABLE public.user_id_seq OWNER TO ccl;
...
ALTER TABLE public.user_password OWNER TO ccl;
...
ALTER TABLE public.user_password_id_seq OWNER TO ccl;
